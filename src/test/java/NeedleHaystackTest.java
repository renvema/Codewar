...
public class NeedleHaystackTest {
    ...
    public void tests() {
        ...
        assertEquals("found the needle at position 3", NeedleHaystack.findNeedle(haystack1));
        assertEquals("found the needle at position 5", NeedleHaystack.findNeedle(haystack2));
        assertEquals("found the needle at position 30", NeedleHaystack.findNeedle(haystack3));
    }
}
